...
export const CheckboxDemo = () => {
  ...
  const [sizeSmallDesc, setSizeSmallDesc] = useState(true);
  const [sizeMediumDesc, setSizeMediumDesc] = useState(false);
  const [sizeLargeDesc, setSizeLargeDesc] = useState(true);
    ...
    <div className="max-w-5xl space-y-8">
      ...
      <DemoSection title="Size Variants">
        <div className="space-y-8">
          ...
          <DemoItem label="Sizes with Descriptions">
            <Checkbox 
              size="sm" 
              label="Small with description" 
              description="This is a small checkbox with additional text"
              checked={sizeSmallDesc}
              onCheckedChange={setSizeSmallDesc}
            />
            <Checkbox 
              size="md" 
              label="Medium with description" 
              description="This is a medium checkbox with additional text"
              checked={sizeMediumDesc}
              onCheckedChange={setSizeMediumDesc}
            />
            <Checkbox 
              size="lg" 
              label="Large with description" 
              description="This is a large checkbox with additional text"
              checked={sizeLargeDesc}
              onCheckedChange={setSizeLargeDesc}
            />
          </DemoItem>
        </div>
      </DemoSection>
      ...
      <DemoSection title="Custom Colors">
        <div className="space-y-8">
          ...
          <DemoItem label="Different Sizes with Custom Colors">
            <Checkbox 
              size="sm"
              customColor="#e91e63"
              label="Small pink"
