      ...
      <DemoSection title="Size Variants">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <DemoItem label="Small">
            <Input size="sm" placeholder="Small size" className="w-[200px]" />
          </DemoItem>
          <DemoItem label="Medium">
            <Input size="md" placeholder="Medium size" className="w-[200px]" />
          </DemoItem>
          <DemoItem label="Large">
            <Input size="lg" placeholder="Large size" className="w-[200px]" />
          </DemoItem>
        </div>
      </DemoSection>
